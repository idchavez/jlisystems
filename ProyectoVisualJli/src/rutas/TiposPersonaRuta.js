...
var TiposPersonaModel = require('../modelos/TiposPersonaModel');


//creamos el ruteo de la clase
module.exports = function()
{
    //muestra el metodo CRUD  listar que muestra todas los tipos de personas 
    router.get("/", function(req, res)
    {
        //Llama el metodo de listar los registros a travez de la instancia de la clase modelo
        TiposPersonaModel.getTiposPersonas(function(error, data)
        {
    ...
    //Muestra el metodo CRUD read(leer), que muestra el tipo de persona solicitada
    router.get("/:id", function (req, res) {
        ...
        if (!isNaN(id)) {
            ...
            TiposPersonaModel.getTipoPersona(id, function (error, data) {
                ...
                //En otro caso mostramos una respuesta de no existe
                    ...
                    res.json(404, { "msg": "Tipo de Persona no Existe" });
                }
            });
    ...
    router.post("/", function(req, res){
        ...
        TiposPersonaModel.insertTipoPersona(TipoPersonaData, function(error, data){
    ...
    router.put("/", function(req, res){
        ...
        TiposPersonaModel.updateTipoPersona(TipoPersonaData, function(error, data){
            //Se muestra el mensaje correspondiente
            if(data && data.msg){
                res.status(200).json(data);
            }else{
